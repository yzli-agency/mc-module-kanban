"""
yzli/kanban — Module Lifecycle Hooks
"""

import logging

logger = logging.getLogger("yzli.kanban")


def on_activate(config: dict):
    """Called when the kanban module is activated."""
    logger.info("Kanban module activated")
    _ensure_tables()
    return True


def on_deactivate():
    """Called when the kanban module is deactivated."""
    logger.info("Kanban module deactivated")
